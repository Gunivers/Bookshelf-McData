...
extract_hitboxes() {
    ...
    javac -classpath "build/$1/*" -sourcepath "src" -d "build/$1" "src/net/gunivers/bookshelf/HitboxExtractor.java"
    java -Xmx2G -classpath "build/$1/*:build/$1" net.gunivers.bookshelf.HitboxExtractor "$1" --pretty
}
